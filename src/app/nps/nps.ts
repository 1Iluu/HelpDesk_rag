  ...
  <div class="flex-1 min-h-0 overflow-y-auto">
    <div class="p-8 space-y-6">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-6" *ngIf="!loading()">
        <div class="flex flex-col gap-4 rounded-xl border border-border-light dark:border-border-dark bg-card-light dark:bg-card-dark p-6 lg:col-span-2">
          ...
          <div class="space-y-5">
            ...
            <!-- Very Good (4 stars) - amarillo -->
            <div class="flex items-center gap-4">
              <div class="flex items-center w-48 text-base">
                <span *ngFor="let s of [1,2,3,4]" class="material-symbols-outlined text-passive !text-2xl" style="font-variation-settings:'FILL' 1">
                  star
                </span>
              ...
              <div class="flex-1 bg-background-light dark:bg-background-dark rounded-full h-4">
                <div class="bg-passive h-4 rounded-full" [style.width.%]="getRatingPercentage(4)"></div>
              </div>
              <div class="w-20 text-right text-text-light dark:text-text-dark font-semibold text-lg">
            ...
            <div class="flex items-center gap-4">
              <div class="flex items-center w-48 text-base">
                <span *ngFor="let s of [1,2,3]" class="material-symbols-outlined text-detractor !text-2xl" style="font-variation-settings:'FILL' 1">
                  star
                </span>
              ...
              <div class="flex-1 bg-background-light dark:bg-background-dark rounded-full h-4">
                <div class="bg-detractor h-4 rounded-full" [style.width.%]="getRatingPercentage(3)"></div>
              </div>
              <div class="w-20 text-right text-text-light dark:text-text-dark font-semibold text-lg">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 lg:col-span-2" *ngIf="!loading()">
        ...
        <div class="rounded-xl border border-border-light dark:border-border-dark bg-card-light dark:bg-card-dark p-6 lg:col-span-2">
            <h3 class="text-text-light dark:text-text-dark text-xl font-semibold mb-4">Top Two Box</h3>
              <div class="flex flex-col md:flex-row items-center gap-6 md:gap-12">
                  <div class="relative w-48 h-48">
                  <svg class="w-full h-full" viewBox="0 0 36 36">
                  <path class="text-background-dark" d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831" fill="none" stroke="currentColor" stroke-width="4"></path>
                  <path class="text-primary" d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831" fill="none" stroke="currentColor" stroke-dasharray="75, 100" stroke-linecap="round" stroke-width="4"></path>
                  </svg>
                  <div class="absolute inset-0 flex flex-col items-center justify-center">
                  <span class="text-5xl font-bold text-text-dark">84%</span>
                  <span class="text-base text-text-secondary-dark">Highly Satisfied</span>
                  </div>
                  </div>
                  <div class="flex-1 space-y-4">
                  <p class="text-text-secondary-light dark:text-text-secondary-dark">The Top Two Box score represents the percentage of customers who gave the highest possible ratings ("Excellent" and "Very Good"). This is a key indicator of strong customer loyalty and satisfaction.</p>
                  <div class="flex items-center gap-4">
                  <div class="w-8 h-8 rounded-full bg-promoter flex items-center justify-center">
                  <span class="material-symbols-outlined text-white" style="font-variation-settings: 'FILL' 1;">thumb_up</span>
                  </div>
                  <div>
                  <p class="font-semibold text-text-light dark:text-text-dark">Excellent + Very Good</p>
                  <p class="text-sm text-text-secondary-light dark:text-text-secondary-dark">44% + 45% = 84%</p>
                </div>
              </div>
            </div>
          </div>
